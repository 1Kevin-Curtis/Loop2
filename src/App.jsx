...
.holes{display:grid;grid-template-columns:repeat(3,1fr);gap:14px}.holes button{border:1px solid rgba(126,219,180,.18);background:var(--off);color:rgba(15,45,46,.58);border-radius:22px;padding:20px 8px;min-height:92px;font-size:16px}.holes button.saved{background:var(--pale);color:var(--mint);border:1px solid var(--soft)}.holes b{display:block;font-size:30px;font-weight:800;line-height:1}.holes span{display:block;font-size:10px;margin-top:3px}
