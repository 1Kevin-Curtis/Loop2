...
function Welcome({go}) {
  return <div className="screenWrap">
    <div className="welcome">
      ...
      <h1 className="heroTitle">An easier way to track your round, spot patterns and play your next round with a clearer plan.</h1>
      ...
      <Card>
        ...
        <div className="welcomeReasons">
          <Card soft>
            <h3>Track rounds quickly</h3>
            <p>Fast post-hole input designed for real golf rounds.</p>
          </Card>

          <Card soft>
            <h3>Spot patterns in your golf</h3>
            <p>Understand what is consistently helping or hurting your scores.</p>
          </Card>

          <Card soft>
            <h3>Build smarter next-round plans</h3>
            <p>Loop adapts guidance as your rounds and trends evolve.</p>
          </Card>
        </div>
...
.card{
  box-shadow:
    0 1px 2px rgba(15,45,46,.03),
    0 12px 32px rgba(15,45,46,.04);
  transition:
    transform .18s ease,
    box-shadow .18s ease,
    background .2s ease;
