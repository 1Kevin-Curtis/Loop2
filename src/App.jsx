  ...
  return <div className="screenWrap">
    ...
    <div className="stack">
      ...
      <Card>
        ...
        <h3>Driving accuracy improving over recent rounds.</h3>
      </Card>

      <Card>
        <p className="eyebrow">Stable strength</p>
        <h3>Putting confidence holding steady.</h3>
      </Card>

      <Card soft>
        <p className="eyebrow">Current focus</p>
        <h3>Approach distance control still costing shots.</h3>
      </Card>

      <Card>
        <p className="eyebrow">Confidence</p>
        <h3>Building pattern</h3>
        <p>Confidence strengthens as more rounds are logged.</p>
      </Card>
