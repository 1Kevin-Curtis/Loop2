...
<Card soft>
  ...
  <h3>Approach distance control remains the clearest scoring opportunity right now.</h3>
  <p>Your recent rounds suggest driving confidence is becoming more stable.</p>
</Card>
...
function Practice({go}) {
  ...
  return <div className="screenWrap">
    <Header title="Practice plan shaped by your recent rounds" sub="Simple and practical."/>
...
function Rounds({go}) {
  return <div className="screenWrap">
    <Header title="Rounds" sub="A simple view of how your golf is evolving."/>
