...
const GAME_MEMORY = {
  ...
  practiceReason: "Recent rounds showed increasing short-right approach misses from mid irons."
};
...
const STORYLINE_EVENTS = [
  ...
  },
  {
    ...
    body: "Your pace control and first putt proximity improved significantly."
  }
];

function MemoryCard({ eyebrow, title, body }) {
  return (
    <div
      style={{
        background: "#12271e",
      ...
      {screen === "story" && (
        <div style={{ padding: 24 }}>
          ...
          <MemoryCard
            ...
            title="Turning bogeys into pars through better approach consistency"
            body="Your driving and putting are becoming more stable, making approach play the clearest scoring opportunity."
          />

          <div style={{ marginTop: 36, marginBottom: 16, fontSize: 24, fontWeight: 700 }}>
            Momentum
          </div>

          {STORYLINE_EVENTS.map((event, index) => (
            <MemoryCard
              key={index}
              eyebrow={event.type}
              title={event.title}
          ...
          <div style={{ marginTop: 34, marginBottom: 16, fontSize: 24, fontWeight: 700 }}>
            Round storyline
          </div>
          ...
          >
            {[
              "Best driving round yet",
              "Penalty shots reduced significantly",
              "Approach play becoming the next focus area",
              "Short game saving more pars"
            ].map((item, index) => (
              <div
                key={index}
                style={{
