...
const screens = ["welcome","profile","home","rounds","ready","setup","round","hole","review","plan","practice",];
...
function Profile({go}) {
  ...
  return <div className="screenWrap">
    ...
    <div className="stack"><Card soft><h3>Storyline</h3><p>Your recent rounds are starting to reveal clear scoring patterns and tendencies. Loop adapts guidance as your golf evolves over time.</p></Card>
...
function Home({go}) {
  return <div className="screenWrap">
    ...
    </div><Card soft><h3>Progression confidence</h3><p>The more rounds you play, the more confidently Loop can identify recurring strengths, scoring patterns and focus areas.</p></Card>
...
function Rounds({go}) {
  return <div className="screenWrap">
    <Header title="Rounds" sub="Your evolving golf story."/>
