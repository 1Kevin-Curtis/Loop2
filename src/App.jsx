  ...
  return <div className="screenWrap">
    ...
    <div className="stack">
      {roundHistory.map((r,i)=>(
        <Card key={i}><button className="roundButton" onClick={()=>{setSelectedRound(r);go("roundStory")}}>
...
const roundHistory = [
  {
    ...
    score:"82 (+11)",
    date:"14 May 2026",
    improved:"Driving accuracy improving over the last two rounds.",
  ...
  return <div className="screenWrap">
    ...
    <div className="stack">
      ...
      <Card dark>
        ...
        <p>Connected improvement story from your recent rounds.</p>
      </Card>

      <Card>
        <p className="eyebrow">↑ Improved</p>
      ...
      <Card>
        ...
        <p>Pattern confidence strengthens as more rounds are connected together.</p>
      </Card>
...
.roundButton{width:100%;border:0;background:none;text-align:left;padding:0}.eyebrow{
