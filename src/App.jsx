...
const screens = ["welcome", "profile", "home", "ready", "setup", "round", "hole", "review", "plan", "prompt", "practice", "story"];


const STORY_MOMENTS = [
  {
    title: "Driving accuracy improving",
    detail: "You have hit more fairways across your last 3 rounds.",
    confidence: "Emerging trend"
  },
  {
    title: "3-putts reducing",
    detail: "Your pace control on the greens is becoming more consistent.",
    confidence: "Building confidence"
  },
  {
    title: "Approach play now the biggest opportunity",
    detail: "Most dropped shots are coming from 140-170 yards.",
    confidence: "Consistent pattern"
  }
];

function MomentumCard({ title, detail, confidence }) {
  return (
    <div style={{
      background: "#13291f",
      borderRadius: 24,
...
function StoryTimeline() {
  const entries = [
    {
      round: "Round 12",
      summary: "Best driving round so far. No penalty shots recorded."
    },
    {
      round: "Round 11",
      summary: "Scrambling improved. Saved par 4 times from missed greens."
    },
    {
      round: "Round 10",
      summary: "Approach misses started clustering short-right from mid irons."
    }
  ];
      ...
      {screen === "story" && (
        <div style={{ padding: 24 }}>
          ...
          <div style={{
            ...
            A rolling view of how your golf is evolving over time.
          </div>
          ...
          <MomentumCard
            title="Approach play becoming the next scoring opportunity"
            detail="Your driving and putting are stabilising, which means approach control is now having the biggest influence on score."
            confidence="Based on recent rounds"
          />
...
.handicapRow button{
  box-shadow:0 4px 12px rgba(15,45,46,.06);
  transition:all .16s ease;
}

.handicapRow button:active{
  transform:scale(.96);
}
