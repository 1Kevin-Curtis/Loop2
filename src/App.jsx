  ...
  return <div className="screenWrap">
    ...
    <div className="stack">
      ...
      <Card soft>
        ...
        <button className="storyLink" onClick={()=>{setSelectedRound(r);go("roundStory")}}>View story</button><div className="pills">
  ...
  return <div className="screenWrap">
    ...
    <div className="stack">
      ...
      <Card>
        ...
        <h3>{roundStoryData.improved}</h3>
      </Card>

      <Card>
        <p className="eyebrow">Stable strength</p>
        <h3>{roundStoryData.stable}</h3>
      </Card>

      <Card soft>
        <p className="eyebrow">Current focus</p>
        <h3>{roundStoryData.focus}</h3>
      </Card>

      <Card>
        <p className="eyebrow">Confidence</p>
        <h3>{roundStoryData.confidence}</h3>
        <p>Pattern confidence strengthens as more rounds are logged.</p>
      </Card>
...
.storyLink{margin-top:14px;border:0;background:none;color:#17A589;font-weight:700;padding:0}.eyebrow{
