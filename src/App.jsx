...
const screens = ["welcome","profile","home","rounds","roundsStory","ready","setup","round","hole","review","plan","practice","progress"];
...
const roundStories = [
  {
    ...
    score:"82 (+11)",
    date:"14 May 2026",
    improved:"Driving accuracy improved from previous round.",
    stable:"Putting confidence holding steady.",
    regressed:"Approach distance control still costing shots.",
  ...
  },
  {
    ...
    score:"85 (+14)",
    date:"7 May 2026",
    improved:"Short-game recovery improving.",
    stable:"Tee-shot confidence stable.",
    regressed:"Penalty shots increasing.",
...
function Rounds({go,setSelectedRound}) {
  return <div className="screenWrap">
    ...
    <div className="stack">
      ...
      <Card soft>
        <h3>Progress confidence</h3>
        <p>Patterns become more reliable as more rounds are logged and connected together.</p>
      </Card>

      {roundStories.map((r)=>(
        <Card key={r.id}>
          <button className="roundStoryBtn" onClick={() => { setSelectedRound(r); go("roundsStory"); }}>
...
function RoundStory({selectedRound,go}) {
  ...
  return <div className="screenWrap">
    ...
    <div className="stack">
      ...
      <Card dark>
        <h2>{selectedRound.score}</h2>
        <p>Connected improvement story built from your recent rounds.</p>
      </Card>
      ...
      <Card soft>
        ...
        <h3>{selectedRound.regressed}</h3>
      </Card>

      <Card>
        <p className="eyebrow">Confidence</p>
        <h3>{selectedRound.confidence}</h3>
        <p>Confidence grows as similar patterns appear across multiple rounds.</p>
      </Card>

      <Btn onClick={()=>go("plan")}>View updated next-round plan</Btn>
...
export default function App() {
  ...
  return <>
    ...
    {screen==="rounds" && <Rounds go={go} setSelectedRound={setSelectedRound}/>} {selectedRound && screen==="roundsStory" && <RoundStory selectedRound={selectedRound} go={go}/>}
