...
.coursePills .pill{max-width:100%;text-align:left;line-height:1.25}.courseSelect{width:100%;height:54px;border-radius:16px;border:1px solid rgba(15,45,46,.12);padding:0 14px;font-size:15px;background:white;margin-top:10px}.courseMeta{margin-top:12px}.courseSelect{width:100%;height:54px;border-radius:16px;border:1px solid rgba(15,45,46,.12);padding:0 14px;font-size:15px;background:white;margin-top:10px}.courseMeta{margin-top:14px}
